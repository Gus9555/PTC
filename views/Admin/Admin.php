...
WHERE estado = 'activo'";
    ...
    // Consulta para obtener la cantidad de seguros por tipo y calidad para Utility, Vehicle, Motorcycle
    $sqlQuality = "SELECT 
                    seguro,
                    calidad, 
                    COUNT(*) as cantidad 
                ...
                <ul class="navbar-right list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                            <a class="dropdown-item" href="../Admin_spanish/Admin.php"><img
            ...
            <div class="content">
                <div class="container-fluid">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">Welcome to LifeLine Dashboard</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Medical Earnings</h5>
                        ...
                        <div class="col-md-4 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Home Earnings</h5>
                        ...
                        <div class="col-md-4 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Utility Earnings</h5>
                        ...
                        <div class="col-md-4 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Motorcycle Earnings</h5>
                        ...
                        <div class="col-md-4 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Vehicle Earnings</h5>
                        ...
                        <div class="col-md-4 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Total Earnings</h5>
                                            <h4 class="text-primary pt-1 mb-0">
                        ...
                        <div class="col-md-4 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center p-1">
                                        <div class="col-lg-12">
                                            <h5 class="font-16">Associate Fee Earnings</h5>
                                            <h4 class="text-info pt-1 mb-0">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">Requests Statistics</h4>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">Medical Insurance Quality Statistics</h4>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">Home Insurance Quality Statistics</h4>
                                    <div style="max-width: 700px; margin: auto;">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title mb-4">Utility, Vehicle, and Motorcycle Insurance
                ...
                <script>
                    ...
                    var userChart = new Chart(ctx, {
                        type: 'doughnut',
                        data: {
                            labels: ['Admins', 'Regular Users', 'Support'],
                            datasets: [{
                                label: 'Number of Users',
                                data: [<?php echo $result['total_admins']; ?>, <?php echo $result['total_regular_users']; ?>, <?php echo $result['total_support']; ?>],
                                backgroundColor: [
                                    'rgba(59, 93, 80, 1)',  // Red mate
                                    'rgba(54, 162, 235, 1)',  // Blue mate
                                    'rgba(249, 191, 41, 1)'   // Yellow mate
                                ],
                                borderColor: [
                                    'rgba(59, 93, 80, 1)',  // Red mate
                                    'rgba(54, 162, 235, 1)',  // Blue mate
                            ...
                            datasets: [
                                {
                                    ...
                                    backgroundColor: 'rgba(59, 93, 80, 1)',  // Red mate
                                ...
                                },
                                {
                                    ...
                                    backgroundColor: 'rgba(54, 162, 235, 1)',  // Blue mate
                                    borderColor: 'rgba(54, 162, 235, 1)',
                                    borderWidth: 1
                                },
                                {
                                    ...
                                    backgroundColor: 'rgba(249, 191, 41, 1)',  // Yellow mate
                                    borderColor: 'rgba(249, 191, 41, 1)',
                                    borderWidth: 1
                                }
                            ]
                            ...
                            datasets: [
                                {
                                    ...
                                    backgroundColor: [
                                        ...
                                        'rgba(255, 215, 0, 1)',    // Gold mate
                                        'rgba(185, 242, 255, 1)'   // Diamond mate
                                    ],
                                    borderColor: [
                                        'rgba(192, 192, 192, 1)',  // Silver mate
                                        'rgba(255, 215, 0, 1)',    // Gold mate
