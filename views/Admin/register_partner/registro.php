        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../../Admin_spanish/register_partner/registro.php">ESPAÑOL <span
                    ...
                    <div class="form-container">
                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <label class="small mb-1" for="usuario">You must enter the same E-mail you used your
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-input" id="inputPassword" onpaste="return false;"
                                            maxlength="50" size="50" name="password" placeholder="Enter password"
                                            type="password" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-input" id="inputConfirmPassword" name="passwordc"
                                            type="password" onpaste="return false;" maxlength="50" size="50"
    ...
    if (empty($nombre) || empty($usuario) || empty($password) || empty($passwordc) || empty($email) || empty($EspacioBlanco)) {
        ...
        if (emailExisteR($pdo, $email_hash)) {
            ...
            if ($stmt5->rowCount() > 0 || $stmt6->rowCount() > 0 || $stmt4->rowCount() > 0) {
                ...
                if ($registro > 0) {
                    $url = 'http://' . $_SERVER["SERVER_NAME"] . '/PTC2/views/Admin/register_partner/activar.php?id=' . $registro . '&val=' . $token;
                   ...
                   window.location = "../../Admin/register_partner/registro.php";
               });</script></p>';
                    }
                } else {
                    echo '<p><script>Swal.fire({
