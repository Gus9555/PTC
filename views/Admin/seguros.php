                ...
                <ul class="navbar-right list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                            <a class="dropdown-item" href="../Admin_spanish/seguros.php"><img
                    ...
                    <li class="dropdown notification-list list-inline-item">
                        <div class="dropdown notification-list nav-pro-img">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                ...
                                <a class="dropdown-item text-danger" href="../user/logout.php"><i class="mdi mdi-power text-danger"></i> Logout</a>
                            </div>
                        </div>
                    </li>
                </ul>
                                        ...
                                        <tbody>
                                            <?php foreach ($resultado as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row['description2']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['description3']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['description4']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['description5']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['description6']); ?></td>
                                                    <td>$<?php echo htmlspecialchars($row['precio']); ?></td>
                                                    <td>
                                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal" data-id="<?php echo $row['id']; ?>" data-seguro="<?php echo $row['seguro']; ?>" data-calidad="<?php echo $row['calidad']; ?>" data-descripcion="<?php echo $row['descripcion']; ?>" data-descripcion2="<?php echo $row['descripcion2']; ?>" data-descripcion3="<?php echo $row['descripcion3']; ?>" data-descripcion4="<?php echo $row['descripcion4']; ?>" data-descripcion5="<?php echo $row['descripcion5']; ?>" data-descripcion6="<?php echo $row['descripcion6']; ?>" data-precio="<?php echo $row['precio']; ?>">Edit</button>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
