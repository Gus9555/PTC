                    ...
                    <ul class="navbar-right list-inline float-right mb-0">
                        ...
                        <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                                <a class="dropdown-item" href="../Admin_spanish/Tabla_taller.php"><img
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center ">
                                <div class="col-md-8">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Associates Table</h4>
                                        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">LifeLine Associates Table</h4>
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Agency type</th>
                                                    <th>Name Mechanical Workshop</th>
                                                    <th>Owners' Name</th>
                                                    <th>Personal ID</th>
                                                    <th>Department</th>
                                                    ...
                                                    <th>Email</th>
                                                    <th>Documentation</th>
                                                    <th>Application for subscription</th>
                                                    <th>Action</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($resultado as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><a href='../Admin/Descarga_doc/download.php?id=<?php echo $row['id']; ?>'>Download the submitted Documentation</a></td>
