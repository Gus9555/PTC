                    ...
                    <ul class="navbar-right list-inline float-right mb-0">
                        ...
                        <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                                <a class="dropdown-item" href="../Admin_spanish/tabla_compras.php"><img
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    <div id="sidebar-menu">
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="tabla_compras.php" class="waves-effect"><i
                                        class="fas fa-dollar-sign"></i><span>
                                        Purchase register </span></a>
                            </li>
                            <li>
                                <a href="seguros.php" class="waves-effect"><i class="fas fa-shield-alt"></i><span>
                                        Insurance
                                        Table </span></a>
                            </li>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center ">
                                <div class="col-md-8">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Purchase Table</h4>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Purchase Table</h4>
                                        <p class="sub-title">Here you can see all the registered payments on the
                                            platform
                                        </p>
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = "POST";
                form.action = "eliminar_compra.php";
