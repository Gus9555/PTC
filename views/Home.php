        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="Home_s.php">ESPAÑOL <span
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Fire or lightning</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Earthquake, tremor or volcanic eruption</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Gas leaks</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Pipe bursting</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Temporary transfers</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Theft</div></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" id="argoTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true"><i class="fas fa-house-damage"></i>Home</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <form method="POST" action="actions/Create_home.php">
                                                <br>
                                                <input type="hidden" name="tipo_seguro" value="Home">
                                                <button type="submit" class="btn-solid-reg page-scroll" name="pdf" value="Home">More Information</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
