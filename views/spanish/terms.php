            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p>Tivo also automatically collects and receives certain information from your computer or
                            ...
                            section and we want to keep you informed about it.</p>
                                ...
                                <ul class="list-unstyled li-space-lg indent">
                                    <li class="media">
                                        ...
                                        <div class="media-body">The geographic area where you use your computer and
                                            mobile devices should be the same with the one of your software</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                    ...
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">A unique Tivo user ID (an alphanumeric string) which is
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">Your IP Address and, when applicable, timestamp related
                                            to your consent and confirmation of consent but please make sure it does
                                        </div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                ...
                                <ul class="list-unstyled li-space-lg indent">
                                    <li class="media">
                                        ...
                                        <div class="media-body">Your billing address and any necessary other information
                                            ...
                                            Services, we may also collect your credit card or PayPal information or any
                    ...
                    <div class="text-container">
                        ...
                        <p>Tivo Landing Page Template uses visitors' data for the following general purposes and for
                        ...
                        <ol class="li-space-lg">
                            ...
                            <li>To sell or market Tivo Landing Page products and services to you or in other parts of
                    ...
                    <div class="text-container">
                        ...
                        <p>Tivo is a HTML landing page template tool. By its nature, Services enable our customers to
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="text-container last">
                                ...
                                <p>Tivo Landing Page uses tracking technology on the landing page, in the Applications,
                                    and in the Platforms, including mobile application identifiers and a unique Tivo
                                    user ID to help us. Recognize you across different Services, to monitor usage and
                                    web traffic routing for the Services, and to customize and improve the Services.</p>
                                <p>By visiting Tivo or using the Services you agree to the use of cookies in your
                                    browser and HTML-based emails. You visit a website, by using any of the Services, or
                                    submitting or collecting any Personal Information via the Services, you consent and
                                    use of your <a class="blue" href="#your-link">Personal Information</a></p>
                            </div> <!-- end of text container -->
                        </div> <!-- end of col-->
                        <div class="col-md-6">
                            ...
                            <div class="form-container">
                                <form id="privacyForm" data-toggle="validator" data-focus="false">
                                    ...
                                    <div class="form-group checkbox">
                                        ...
                                        and agree to Tivo's <a href="privacy-policy.html">Privacy Policy</a> and <a
