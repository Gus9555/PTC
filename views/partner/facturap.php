...
// Get id_compra (it may come from a form or URL)
...
$pdo = null;
ob_end_flush(); // Limpia el buffer de salida y muestra el contenido
?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Thank you for trusting us with your life and your loved ones, as well as for trusting us to protect your belongings. At LifeLine, we work for a safer future for you. We hope to see you soon.
                        </p>

                        <a class="btn-solid-reg page-scroll" href="index.php">Home</a>
