        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../user/S_Doctor.php">ENGLISH <span
                                class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>Red de medicos de Lifeline</h1>
                            <p class="p-large">En lifeLine priorizamos tu salud, por eso te ofrecemos el contacto de nuestra red de Médicos.</p>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mb-5 mb-md-0">
                <h2 class="h3 mb-3 text-black">Red de medicos de Lifeline</h2>
                <div class="wrapper">
                    <form method="POST" class="border p-4">
                        <div class="form-group">
                            <label for="specialty" class="text-black">Especialidad  </label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="searchName" class="text-black">Buscar Nombre</label>
            ...
            <div class="col-md-6">
                <h2 class="h3 mb-3 text-black">Lista de Doctores</h2>
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if ($doctors) {
                                foreach ($doctors as $doctor) {
                                    ...
                                    echo "<p><span>Especialidad:</span> <span>" . htmlspecialchars($especialidades[$doctor['especialidad']]) . "</span></p>";
                                    echo "<p><span>Subespecialidad:</span> <span>" . htmlspecialchars($doctor['subespecialidad']) . "</span></p>";
                                    echo "<p><span>Departamento:</span> <span>" . htmlspecialchars($departamentos[$doctor['zona_medica']]) . "</span></p>";
                                    echo "<p><span>Ubicación de la clínica:</span> <span>" . htmlspecialchars($doctor['direccion_clinica']) . "</span></p>";
                                    echo "<p><span>Teléfono:</span> <span class='phone-number'>" . htmlspecialchars($doctor['telefono']) . "</span></p>";
                                    echo "<p><span>Correo electrónico:</span> <span>" . htmlspecialchars($doctor['email']) . "</span></p>";
                                    echo "</div>";
                                ...
                                echo "<p>No se han encontrado médicos.</p>";
                            }
                        }
                        ?>
                    </div>
