<?php
    ...
    if (!empty($_POST)) {
        // Obtener y sanitizar los parámetros del formularioasasasa
                    ...
                    if ((int) $usuarioData['activacion'] === 1) {
                        ...
                        if ($password == $usuarioData['password']) {
                            ...
                            switch ($_SESSION['tipo_usuario']) {
                                case "2":
                                    header("location:../user_spanish/view_user.php");
                                    exit;
                                case "1":
                                    header("location:../Admin_spanish/Admin.php");
                                    exit;
                                case "3":
                                    header("location:../support_spanish/users.php");
                                    exit;
                                default:
                                    echo '<p><script>Swal.fire({
                                        title: "ERROR",
                                        text: "Usuario no activo, revise su correo",
                                        icon: "error"
                                        });</script></p>';
                            }
                        } else {
    ...
    <body data-spy="scroll" data-target=".fixed-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image" href="../index_spanish.php"><img src="../../assets/boss/images/logo.png"
                        alt="alternative"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link page-scroll" href="../index_spanish.php">INICIO<span
                    ...
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="../user_spanish/registro.php">REGISTRATE</a>
                    </span>
                </div>
                        ...
                        <div class="form-container">
                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="loginForm">
                                ...
                                <div class="form-group">
                                    <input class="form-control-input" id="inputEmailAddress" onpaste="return false;" onkeypress="return (event.charCode == 209 || event.charCode == 241 || (event.charCode >= 64 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 45)||(event.charCode == 46)||(event.charCode == 95)||(event.charCode >= 48 && event.charCode <= 57))" maxlength="50" size="50" 
                                    name="correo" type="email"
                                        placeholder="Ingrese su direccion de correo electronico" required />
                                </div>

                                <div class="form-group">
                                    <input class="form-control-input" onpaste="return false;" maxlength="50" size="50" id="inputPassword" name="password" type="password"
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" id="rememberPasswordCheck"
                                            type="checkbox" />
                                        <label class="custom-control-label" for="rememberPasswordCheck">Recordar</label>
                                    </div>
                                </div>
                                ...
                                <br>
                                <div class="form-group">
                                    <a class="small" href="../user/restorePass.php">Olvido su contraseña?</a>
                                </div>
                            </form>
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        switch (data.user_type) {
                            case "2":
                                window.location.href = "../user_spanish/view_user.php";
                                break;
                            case "1":
                                window.location.href = "../Admin_spanish/Admin.php";
                                break;
                            case "3":
                                window.location.href = "../support_spanish/users.php";
                                break;
                            default:
                                Swal.fire({
                                    title: "ERROR",
