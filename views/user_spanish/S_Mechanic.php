        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../user/S_Mechanic.php">ENGLISH <span
                                class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-5">
                            <div class="text-container">
                                <h1>Red de talleres de Lifeline</h1>
                                <p class="p-large">En lifeLine priorizamos tu seguridad al volante, por eso te
                                te ofrecemos el contacto de nuestra red de talleres.</p>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    <h2 class="h3 mb-3 text-black">Red de talleres de Lifeline</h2>
                    <div class="p-3 p-lg-5 border bg-white">
                        <form method="POST" action="">
                            <div class="form-group">
                                <label for="c_country" class="text-black">Agencia </label>
                                <select id="c_country" name="agency" class="form-control">
                                    <option value="">¿Un taller de agencia o no?</option>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="c_companyname" class="text-black">Nombre del taller</label>
                ...
                <div class="col-md-6">
                    <h2 class="h3 mb-3 text-black">Lista de talleres</h2>
                    <div class="p-3 p-lg-5 border bg-white">
                    <div class="container">
    <?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($workshops) {
            foreach ($workshops as $workshop) {
                ...
                echo "<p><span>Agencia:</span> <span>" . htmlspecialchars($agencias[$workshop['tipo_agencia']]) . "</span></p>";
                echo "<p><span>Nombre del propietario:</span> <span>" . htmlspecialchars($workshop['nombre_dueño']) . "</span></p>";
                echo "<p><span>Departamento:</span> <span>" . htmlspecialchars($departamentos[$workshop['direccion']]) . "</span></p>";
                echo "<p><span>Lugar del taller:</span> <span>" . htmlspecialchars($workshop['ubicacion_taller']) . "</span></p>";
                echo "<p><span>Teléfono:</span> <span class='phone-number'>" . htmlspecialchars($workshop['telefono_fijo']) . "</span></p>";
                echo "<p><span>Correo electrónico:</span> <span>" . htmlspecialchars($workshop['email']) . "</span></p>";
                echo "<p><span>Tipo de agencia:</span> <span>" . htmlspecialchars($agencias[$workshop['tipo_agencia']]) . "</span></p>";
                echo "</div>";
            ...
            echo "<p>No se han encontrado talleres.</p>";
        }
    }
    ?>
                    </div>
