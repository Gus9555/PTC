        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../user/S_Architect.php">ENGLISH <span
                                class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-5">
                            <div class="text-container">
                                <h1>Red de reparaciones de inmuebles</h1>
                                <p class="p-large">En lifeLine priorizamos la seguridad de tu hogar, por eso te
                                te ofrecemos el contacto de nuestra red de constructoras.</p>
                            </div> <!-- end of text-container -->
                        </div> <!-- end of col -->
                        <div class="col-lg-6 col-xl-7">
                            <div class="image-container">
                                <div class="img-wrapper">
                                    <img class="img-fluid" src="../../assets/boss/images/arquiW.png" alt="alternative">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    <h2 class="h3 mb-3 text-black">Red de reparaciones de inmuebles</h2>
                    <div class="p-3 p-lg-5 border bg-white">
                        <form method="POST" action="">
                            <div class="form-group">
                                <label for="agency" class="text-black">Agencia </label>
                                <select id="agency" name="agency" class="form-control">
                                    ...
                                    <option value="2">No Agencia</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="department" class="text-black">Departamento </label>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="company_name" class="text-black">Nombre de la compañia</label>
                                    <input type="text" class="form-control" id="company_name" name="company_name">
                                </div>
                            </div>

                            <div class="form-group">
                                <button type="submit" class="btn-outline-sm">Buscar</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-md-6">
                    <h2 class="h3 mb-3 text-black">Lista de constructores</h2>
                    <div class="p-3 p-lg-5 border bg-white">
                        <div class="container">
                            <?php
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                $sql = "SELECT * FROM constructuras WHERE activation = 1";
                                $params = [];
                                ...
                                if (!empty($company_name)) {
                                    $sql .= " AND nombre_constructora LIKE ?";
                                    $params[] = "%$company_name%";
                                }
                                ...
                                if ($constructoras) {
                                    foreach ($constructoras as $constructora) {
                                        $modalId = 'modal' . htmlspecialchars($constructora['id']); // Assuming 'id' is a unique identifier for the constructor
                                        echo "<div class='constructor-item' data-toggle='modal' data-target='#$modalId'>";
                                        echo "<div class='icon'><i class='fas fa-hard-hat'></i></div>";
                                        echo "<h5>" . htmlspecialchars($constructora['nombre_constructora']) . "</h5>";
                                        echo "</div>";
                                        ...
                                        echo "<h5 class='modal-title' id='{$modalId}Label'><i class='fas fa-hard-hat'></i>" . htmlspecialchars($constructora['nombre_constructora']) . "</h5>";
                                        echo "<button type='button' class='close' data-dismiss='modal' aria-label='Close'>";
                                        echo "<span aria-hidden='true'>&times;</span>";
                                        echo "</button>";
                                        echo "</div>";
                                        echo "<div class='modal-body'>";
                                        echo "<p><span>Nombre del propietario:</span> <span>" . htmlspecialchars($constructora['nombre_dueño']) . "</span></p>";
                                        echo "<p><span>Departamento:</span> <span>" . htmlspecialchars($departamentos[$constructora['departamento']]) . "</span></p>";
                                        echo "<p><span>Lugar del taller:</span> <span>" . htmlspecialchars($constructora['direccion_constructora']) . "</span></p>";
                                        echo "<p><span>Teléfono:</span> <span class='phone-number'>" . htmlspecialchars($constructora['telefono_fijo']) . "</span></p>";
                                        echo "<p><span>Correo electrónico:</span> <span>" . htmlspecialchars($constructora['email']) . "</span></p>";
                                        echo "<p><span>Tipo de agencia:</span> <span>" . htmlspecialchars($agencias[$constructora['tipo_agencia']]) . "</span></p>";
                                        echo "</div>";
                                    ...
                                    echo "<p>No se han encontrado constructores.</p>";
                                }
                            }
                            ?>
                        </div>
