...
// Eliminando las cookies en sesión
...
// ACTUALIZANDO EL ESTADO DE CONEXIÓN DEL USUARIO, ES DECIR, USUARIO DESCONECTADO.
...
if ($stateUpdate > 0) {
	header("Location:../../../views/index.php"); // Redireccionar a index.php
	exit();
}
?>