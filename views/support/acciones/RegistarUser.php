...
//Limpiando input
$nombre_apellido = ($_REQUEST['nombre']);
//Limpiando campo email_user para evitar inyeccion SQL
$correo = filter_var($_REQUEST['correo'], FILTER_SANITIZE_EMAIL);
...
if (move_uploaded_file($file_loc, $target_path)) {
	...
	$sql_insert = ("INSERT INTO 
		users (correo, password, nombre, imagen, fecha_registro, estatus) VALUES ('$email', '$PasswordHash', '$nombre_apellido', '$imgperfil', '$fechaRegistro', '$estatus')");
