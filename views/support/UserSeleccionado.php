...
<body>
  ...
  if (isset($_SESSION['correo']) && isset($_SESSION['id']) && isset($_SESSION['imagen']) && isset($_SESSION['nombre'])) {
        ...
        <div class="row heading">
            <div class="col-sm-2 heading-avatar">
                <a href="./" style="color: #fff;">
                    <div class="eading-avatar-icohn">
                        <i id="arrowIcon" class="zmdi zmdi-arrow-left" style="font-size:20px"></i>
                    </div>
                </a>
            </div>
    ...
    <div class="row reply" id="formnormal">
      <form class="conversation-compose" id="formenviarmsj" name="formEnviaMsj">
        ...
        <input type="hidden" name="to_user" value="<?php echo $rowUser['nombre']; ?> ">
        ...
        <input class="input-msg" name="message" id="message" placeholder="Type your message and press Enter..."
          autocomplete="off" autofocus="autofocus" required="true">
        <i class="zmdi zmdi-comment-image" style="font-size: 45px; color: grey;" title="Enviar Imagen."
          id="mostrarformenviarimg"></i>
      </form>
    </div>
  ...
  <div class="row reply" id="formenviaimg">
    <form class="conversation-compose" id="formenviarimg" name="formEnviaImg" enctype="multipart/form-data">
      <input type="hidden" name="user_id" value="<?php echo $idConectado; ?>">
      <input type="hidden" name="to_id" value="<?php echo $rowUser['id']; ?>">
      <input type="hidden" name="to_user" value="<?php echo $rowUser['nombre']; ?> ">
      <input type="hidden" name="user" value="<?php echo $email_user; ?>">
