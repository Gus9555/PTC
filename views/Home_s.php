...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Logo de imagen -->
            <a class="navbar-brand logo-image" href="index.php"><img src="../assets/boss/images/logo.png" alt="alternativo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="Home.php">INGLES <span class="sr-only">(actual)</span></a>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>En LifeLine nos enfocamos en la salud de nuestros clientes, por eso ofrecemos los mejores planes de seguro de salud. Haz clic abajo para solicitar una cotización de precios.</p>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Incendio o rayo</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Terremoto, temblor o erupción volcánica</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Fugas de gas</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Rotura de tuberías</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Traslados temporales</div></li>
                            <li class="media"><i class="fas fa-square"></i><div class="media-body">Robo</div></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" id="argoTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true"><i class="fas fa-house-damage"></i>Hogar</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <form method="POST" action="cotizar.php">
                                                <br>
                                                <button type="submit" class="btn-solid-reg page-scroll" name="pdf" value="home">Más Información</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../assets/boss/js/jquery.easing.min.js"></script> <!-- jQuery Easing para el desplazamiento suave entre anclas -->
