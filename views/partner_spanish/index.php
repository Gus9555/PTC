...
<body>
        ...
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        ...
                        text: 'Tu pago está actualmente pendiente. Por favor, completa el pago para continuar.',
                        icon: 'warning',
    ...
    switch ($tipo) {
        case 'talleres':
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="small mb-1" for="direccion">Departamento</label>
                    ...
                    <div class="form-group">
                        <label for="ubicacion_taller">Dirección</label>
                    ...
                    <button type="submit" class="btn btn-primary" id="edit" name="edit" value="talleres">Guardar cambios</button>
        </div>
                </form>
            </div>
        </div>';
            ...
            $lista = '<div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Tipo de Agencia</p>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Nombre de la Agencia</p>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Nombre del Dueño</p>
                                        </div>
                                        <div class="col-sm-9">
        ...
        case 'asociados':
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id" id="id" value="' . $correo . '">
                    <div class="form-group">
                        <label class="small mb-1" for="departamento">Departamento</label>
                    ...
                    <button type="submit" class="btn btn-primary" id="edit" name="edit" value="asociados">Guardar cambios</button>
        </div>
                </form>
            </div>
        </div>';
            ...
            $lista = '<div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Especialidad Médica</p>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Subespecialidad Médica</p>
                                        </div>
                                        <div class="col-sm-9">
        ...
        case 'constructuras':
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="ubicacion_constructora">Dirección</label>
                    ...
                    <button type="submit" class="btn btn-primary" id="edit" name="edit" value="constructuras">Guardar cambios</button>
        </div>
                </form>
            </div>
        </div>';
            ...
            $lista = '<div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Nombre de la Constructora</p>
                                        </div>
                                        <div class="col-sm-9">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
                    <div class="container">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse"
                            ...
                            aria-expanded="false" aria-label="Navegación de palanca">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                            ...
                            <span class="nav-item">
                                <a class="btn-outline-sm" href="../user/logout.php">CERRAR SESIÓN</a>
                            </span>
                        </div>
                    </div>
                </nav>
                            ...
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-flex justify-content-center mb-2">
                                        <li class="btn btn-outline-primary ms-1"><a href="../user/logout.php">Cerrar Sesión</a>
                                        </li>
                                        <a href="#openModal">
                                            <button class="btn btn-outline-primary ms-1">EDITAR</button>
                                        </a>
        ...
        <!-- Scripts -->
        <script src="../../assets/boss/js/jquery.min.js"></script> <!-- jQuery para plugins de JavaScript de Bootstrap -->
        <script src="../../assets/boss/js/popper.min.js"></script> <!-- Biblioteca de tooltip de Popper para Bootstrap -->
        ...
        <!-- jQuery Easing para desplazamiento suave entre anclas -->
