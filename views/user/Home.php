        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../user_spanish/Home.php">ESPAÑOL <span
                                class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Here at LifeLine we focus on our customer's health, that's why we offer the best healthcare
                            insurance plans. Click down below to enter a request for a price quote.</p>
                    ...
                    <ul class="nav nav-tabs" id="argoTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab"
                                aria-controls="tab-1" aria-selected="true"><i class="fas fa-house-damage"></i>Home</a>
                        </li>
                    </ul>
