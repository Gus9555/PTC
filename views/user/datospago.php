        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../profile/profile.php">MY PROFILE <span
                                class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        if ($seguro == "Vehicule" || $seguro == "motorcycle" || $seguro == "Utility") {
                            $campos = '<h2>Vehicle Information</h2>
                        <div class="form-group">
                            <label for="tarjeta_circulacion">Circulation Card:</label>
                        ...
                        <div class="form-group">
                            <label for="num_telBene">Phone Number:</label>
                        ...
                        <div class="form-group">
                            ...
                            $campos = '<h2>Insured Person Data</h2>
                        <div class="form-group">
                            <label for="name_asegrd">Full Name:</label>
                            <input type="text" class="form-control" onpaste="return false;"
                        ...
                        <div class="form-group">
                            <label for="vivienda">House Address:</label>
            ...
            <option value="Other">Other</option>
                        ...
                        <form id="paymentForm" action="datospago2.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="numero_telefonico">Phone Number:</label>
                            ...
                            <button type="submit" class="btn-solid-reg page-scroll">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
...
//             echo '<p><script>Swal.fire({
//                 title: "ERROR",
//                 text: "error sending the data3: ' . $e->getMessage() . '",
//                 icon: "error"
//                 });</script></p>';
//         }
