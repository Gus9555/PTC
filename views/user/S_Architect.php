                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-5">
                            <div class="text-container">
                                <h1>LifeLine Home Help Network</h1>
                                <p class="p-large">At lifeLine we prioritize the security of your home, that's why we
                                    offer you the contact of our network of construction company.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    <h2 class="h3 mb-3 text-black">LifeLine Home Help Network</h2>
                    <div class="p-3 p-lg-5 border bg-white">
                        <form method="POST" action="">
                            <div class="form-group">
                                <label for="agency" class="text-black">Agency </label>
                                <select id="agency" name="agency" class="form-control">
                                    <option value="">Select urgency level</option>
                                    <option value="1">Agency</option>
                                    <option value="2">Not Agency</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="department" class="text-black">Department </span></label>
                ...
                <div class="col-md-6">
                    <h2 class="h3 mb-3 text-black">Constructor List</h2>
                    <div class="p-3 p-lg-5 border bg-white">
                        <div class="container">
                            <?php
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if ($constructoras) {
                                    foreach ($constructoras as $constructora) {
                                        ...
                                        echo "<p><span>Owner Name:</span> <span>" . htmlspecialchars($constructora['nombre_dueño']) . "</span></p>";
                                        echo "<p><span>Department:</span> <span>" . htmlspecialchars($departamentos[$constructora['departamento']]) . "</span></p>";
                                        echo "<p><span>Workshop Location:</span> <span>" . htmlspecialchars($constructora['direccion_constructora']) . "</span></p>";
                                        echo "<p><span>Phone:</span> <span class='phone-number'>" . htmlspecialchars($constructora['telefono_fijo']) . "</span></p>";
                                        echo "<p><span>Email:</span> <span>" . htmlspecialchars($constructora['email']) . "</span></p>";
                                        echo "<p><span>Agency Type:</span> <span>" . htmlspecialchars($agencias[$constructora['tipo_agencia']]) . "</span></p>";
                                        echo "</div>";
                                    ...
                                    echo "<p>No constructors found.</p>";
                                }
                            }
                            ?>
                        </div>
