...
if (!isset($_SESSION['id'])) {
    ...
    exit; // Exit script if no session is started
}
...
try {
    ...
    // Function to get insurance data by type
    function getSegurosByTipo($pdo, $type) {
        $sql = "SELECT * FROM seguros WHERE seguro = :type";
    ...
    usort($segurosMedical, 'comparePrices');
...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../user_spanish/Medical.php">ESPAÑOL <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" id="argoTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true"><i class="fas fa-heartbeat"></i>HealthCare</a>
                        </li>
                    </ul>
    ...
    <button type="submit" class="btn-solid-reg page-scroll" name="buy" value="<?php echo htmlspecialchars($seguro['id']); ?>">Buy</button>
</form>

                                            <form method="POST" action="../actions/Create_medical.php">
                                                <button type="submit" class="btn-solid-reg page-scroll" name="pdf" value="medical">Price Quote</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
