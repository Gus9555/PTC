    ...
    if(!empty($_POST))
    {
        ...
        //valida si el email existe y asi poder hacer el proceso del email
            if(emailExiste($email))
            {
                ...
                $url = 'http://'.$_SERVER["SERVER_NAME"].'/PTC/views/user/cambiaPass.php? id='.$user_id.'&token='.$token;
                        ...
                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <form id="loginform" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                    ...
                                    <div>
                                        <a class="small" href="../../views/user/login.php">Return to login</a>
                                    </div>
                                </form>
                                <?php echo resultBlock($errors); ?>
                            </div>
                            <div class="card-footer text-center">
                                <div class="small"><a href="../../views/user/registro.php">No account? Sign up!</a></div>
                            </div>
                        </form>
