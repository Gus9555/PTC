        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../user_spanish/registro.php">ESPAÑOL <span
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-input" id="inputConfirmPassword" name="passwordc"
                                            type="password" onpaste="return false;" maxlength="50" size="50" placeholder="Confirm password" />
                                    </div>
                                </div>
                            </div>
