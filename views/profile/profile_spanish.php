...
<body>
    ...
    Swal.fire({
        ...
        text: 'Su pago mensual está pendiente, revise su correo electrónico.',
...
<div class="card seguro-card">
    <div class="card-body text-center">
        <p class="mb-4"><span class="text-primary font-italic me-1"></span>TODAVÍA NO HA CONTRATADO UN SEGURO</p>
        ...
        <section style="background-color: #3b5d50;">
            <div class="container py-5">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
                    <div class="container">
                        <!-- Image Logo -->
                        <a class="navbar-brand logo-image" href="../user_spanish/view_user.php"><img
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link page-scroll" href="../user_spanish/view_user.php">INICIO <span
                                            class="sr-only">(actual)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link page-scroll" href="profile.php">ENGLISH <span
                                            class="sr-only">(actual)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link page-scroll" href="../support/users.php">SOPORTE-CHAT <span
                                            class="sr-only">(actual)</span></a>
                                </li>

                            </ul>
                            <span class="nav-item">
                                <a class="btn-outline-sm" href="../user_spanish/logout.php">CERRAR SESIÓN</a>
                            </span>
                        </div>
                    </div>
                </nav>
                            ...
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-flex justify-content-center mb-2">
                                        <li class="btn btn-outline-primary ms-1"><a href="../user_spanish/logout.php">Cerrar Sesión</a>
                                        </li>
                                        <li class="btn btn-outline-primary ms-1"><a
                                                href="../user_spanish/view_user.php">Inicio</a>
                                        </li>
                            ...
                            <div class="cards-container">
                                ...
                                foreach ($seguros as $index => $seguro) {
                                    ...
                                    echo '<div class="card seguro-card">
                                        <div class="card-body">
                                            <p class="mb-4"><b>SEGURO</b></p>';
                                    if (strtolower($seguro['seguro']) == 'vehicule') {
                                        echo '<img src="../../assets/boss/images/33.png" alt="Seguro de Vehículo" class="insurance-image">';
                                    } elseif (strtolower($seguro['seguro']) == 'medical') {
                                        echo '<img src="../../assets/boss/images/44.png" alt="Seguro Médico" class="insurance-image">';
                                    } elseif (strtolower($seguro['seguro']) == 'home') {
                                        echo '<img src="../../assets/boss/images/333.png" alt="Seguro de Hogar" class="insurance-image">';
                                    } elseif (strtolower($seguro['seguro']) == 'motorcycle') {
                                        echo '<img src="../../assets/boss/images/motos.png" alt="Seguro de Motocicleta" class="insurance-image">';
                                    } elseif (strtolower($seguro['seguro']) == 'Utility') {
                                        echo '<img src="../../assets/boss/images/tractorcito.png" alt="Seguro de Utilidad" class="insurance-image">';
                                    }
                                    echo '   <p class="mb-1" style="font-size: .77rem;"><b>' . htmlspecialchars($seguro['seguro']) . '</b></p>
                                            ...
                                            <img src="../../assets/images/Diseño_sin_título__4_-removebg-preview.png" alt="Imagen Centrada" class="center-image">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="insuranceModalLabel' . $index . '">' . htmlspecialchars($seguro['seguro']) . ' Seguro</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Tipo de Seguro: ' . htmlspecialchars($seguro['seguro']) . '</p>
                    <p>Calidad del Seguro: ' . htmlspecialchars($seguro['calidad']) . '</p>
                    <p>Nombre: ' . htmlspecialchars($seguro['nombre']) . '</p>
                    <p>Correo Electrónico: ' . htmlspecialchars($seguro['correo']) . '</p>
                    <p>Precio: $' . htmlspecialchars($seguro['precio']) . '</p>
                    <p>Fecha de Compra: ' . htmlspecialchars($seguro['fecha_compra']) . '</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#planSelectionModal' . $index . '">Cambiar Plan de Seguro</button>
                </div>
            </div>
        </div>
    </div>';
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="planSelectionModalLabel' . $index . '">Seleccionar Plan de Seguro</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body text-center">
            <form method="post" action="update_plan2.php">
                ...
                echo '<button type="submit" name="plan" value="Diamond" class="card" ' . $disabled . '>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Plan Diamante</h5>
                        </div>
                    </button>';
