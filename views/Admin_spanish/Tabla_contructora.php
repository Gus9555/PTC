...
<body>
    ...
    if (!isset($_SESSION['id'])) {
        echo '<script>
            Swal.fire({
                title: "Advertencia",
                text: "No has iniciado sesión. Redirigiendo a la página de inicio de sesión...",
                icon: "warning",
    ...
    try {
        ...
        $sqlUsers = "SELECT * FROM constructuras";
        ...
        echo '<script>
            Swal.fire({
                title: "Error",
                text: "La consulta falló: ' . $e->getMessage() . '",
                icon: "error",
                confirmButtonText: "OK"
            });
        </script>';
                ...
                <ul class="navbar-right list-inline float-right mb-0">
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                            <a class="dropdown-item" href="../Admin/Tabla_contructora.php"><img
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="Admin.php" class="waves-effect">
                                <i class="dripicons-meter"></i><span class="badge badge-info badge-pill float-right"></span> <span> Panel de control </span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-list"></i><span>
                                Tabla de Socios <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="Tabla_datosVida.php">Datos de Póliza de Vida</a></li>
                                <li><a href="Tabla_datosCasa.php">Datos de Póliza de Propiedades</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tabla de Socios</h4>
                                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Tabla de Socios de LifeLine</h4>
                                    <p class="sub-title">En esta sección se presenta una lista detallada de todos los usuarios que han
                                        completado el proceso de registro en la plataforma. Aquí puedes acceder a información clave sobre cada usuario, como su nombre de usuario y detalles de contacto si están disponibles. Este recurso proporciona una valiosa visión general de la base de usuarios de la plataforma, lo que puede ayudar en la gestión de la comunidad, la segmentación de la audiencia y el análisis de datos para mejorar la experiencia del usuario.
                                    </p>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nombre de la Constructora</th>
                                                <th>Nombre del Dueño</th>
                                                <th>Número de Teléfono</th>
                                                <th>Teléfono Fijo</th>
                                                <th>Correo Electrónico</th>
                                                <th>Dirección de la Constructora</th>
                                                <th>Departamento</th>
                                                <th>Documentación</th>
                                                <th>Solicitud de Inscripción</th>
                                                <th>Acción</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($resultado as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($agencias[$row['tipo_agencia']]); ?></td>
                                                    <td><?php echo htmlspecialchars($row['nombre_constructora']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['nombre_dueño']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['telefono']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['telefono_fijo']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['email']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['direccion_constructora']); ?></td>
                                                    <td><?php echo htmlspecialchars($departamentos[$row['departamento']]);?></td>
                                                    <td><a href='../Admin_spanish/Descarga_doc/download_C.php?id=<?php echo $row['id']; ?>'>Descargar la Documentación Enviada</a></td>
                                                    <td><?php echo htmlspecialchars($activacion[$row['activation']]); ?> </td>
                                                    <td>
                                                        <form action="Action/accion_solicitud_C.php" method="post">
                                                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                            <input type="hidden" name="id_tipo" value="<?php echo $row['id_tipo']; ?>">
                                                            <button type="submit" name="action" value="accept" class="btn btn-success btn-sm">Aceptar</button>
                                                            <button type="submit" name="action" value="denied" class="btn btn-warning btn-sm">Denegar</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            <?php } ?>
