...
<body>
    ...
    try {
        ...
        $sqlUsers = "SELECT * FROM datos_propiedad";
                    ...
                    <ul class="navbar-right list-inline float-right mb-0">
                        ...
                        <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                                <a class="dropdown-item" href="../Admin/Tabla_datosCasa.php"><img
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center ">
                                <div class="col-md-8">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Tabla de Pólizas de Propiedad</h4>
                                        <ol class="breadcrumb">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Fotos de la Propiedad</th>
                                                    <th>Área de la Propiedad</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($resultado as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><a href='Descarga_doc/download_d_casas.php?id=<?php echo $row['id']; ?>'>Descargar la Documentación Enviada</a></td>
                                                        <td><?php echo htmlspecialchars($row['area']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['num_habitaciones']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['direccion_propiedad']);?></td>
                                                        ...
                                                        <td>
                                                            <form action="Action/accion_casa.php" method="post" >
