                ...
                <ul class="navbar-right list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                            <a class="dropdown-item" href="../Admin/update_insurance.php"><img
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg px-1">
                            ...
                            <div class="slimscroll notification-item-list">
                                <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                    ...
                                    <p class="notify-details"><b>Tu pedido ha sido realizado</b><span class="text-muted">Texto de relleno de la industria de la impresión y composición tipográfica.</span></p>
                                </a>

                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-danger"><i class="mdi mdi-message-text-outline"></i>
                                    </div>
                                    <p class="notify-details"><b>Nuevo Mensaje recibido</b><span class="text-muted">Tienes 87 mensajes sin leer</span></p>
                                </a>

                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-info"><i class="mdi mdi-filter-outline"></i></div>
                                    <p class="notify-details"><b>Tu artículo ha sido enviado</b><span class="text-muted">Es un hecho bien establecido que un lector se distraerá con el contenido</span></p>
                                </a>
                        ...
                        <div class="dropdown notification-list nav-pro-img">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                ...
                                <a class="dropdown-item d-block" href="#"><span
                                        ...
                                        class="mdi mdi-settings"></i> Configuración</a>
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-list"></i><span>
                                    Tabla de Socios <span class="float-right menú-flecha"><i
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-list"></i><span>
                            Tabla de Beneficiarios Registrados <span class="float-right menú-flecha"><i
                                            class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">LifeLine Editar Seguro</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary btn-sm"
                                                            ...
                                                            data-precio="<?php echo $row['precio']; ?>">Editar</button>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
