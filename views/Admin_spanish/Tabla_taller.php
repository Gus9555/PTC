                    ...
                    <ul class="navbar-right list-inline float-right mb-0">
                        ...
                        <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                                <a class="dropdown-item" href="../Admin/Tabla_taller.php"><img
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center ">
                                <div class="col-md-8">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Tabla de Talleres Mecánicos</h4>
                                        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Tabla de Talleres Mecánicos de LifeLine</h4>
                                        <p class="sub-title">En esta sección se presenta una lista detallada de todos los usuarios que han completado el proceso de registro en la plataforma. Aquí puedes acceder a información clave sobre cada usuario, como su nombre de usuario y datos de contacto si están disponibles. Este recurso proporciona una valiosa visión general de la base de usuarios de la plataforma, lo que puede ayudar en la gestión de la comunidad, la segmentación de la audiencia y el análisis de datos para mejorar la experiencia del usuario.
                                        </p>
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Nombre del Taller Mecánico</th>
                                                    ...
                                                    <th>Documentación</th>
                                                    <th>Solicitud de Suscripción</th>
                                                    <th>Acción</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($resultado as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($departamentos[$row['direccion']]);?></td>
                                                        <td><?php echo htmlspecialchars($row['ubicacion_taller']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['telefono_fijo']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['telefono_personal']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['email']); ?></td>
                                                        <td><a href='../Admin_spanish/Descarga_doc/download.php?id=<?php echo $row['id']; ?>'>Descargar la Documentación Presentada</a></td>
                                                        <td><?php echo htmlspecialchars($activacion[$row['activation']]); ?> </td>
                                                        <td>
                                                            <form action="Action/accion_solicitud.php" method="post" >
