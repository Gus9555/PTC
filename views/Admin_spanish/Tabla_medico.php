...
<body>
    ...
    try {
        ...
        $sqlUsers = "SELECT * FROM asociados";
                    ...
                    <ul class="navbar-right list-inline float-right mb-0">
                        ...
                        <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                                <a class="dropdown-item" href="../Admin/Tabla_medico.php"><img
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center ">
                                <div class="col-md-8">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Tabla de Asociados</h4>
                                        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Tabla de Asociados de LifeLine</h4>
                                            ...
                                            <tbody>
                                                <?php foreach ($resultado as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($row['jvpm']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['nit']); ?></td>
                                                        <td><?php echo htmlspecialchars($especialidades[$row['especialidad']]);?></td>
                                                        <td><?php echo htmlspecialchars($row['subespecialidad']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['email']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['direccion_clinica']); ?></td>
                                                        <td><?php echo htmlspecialchars($departamentos[$row['zona_medica']]);?></td>
                                                        <td><a href='../Admin_spanish/Descarga_doc/download_Doc.php?id=<?php echo $row['id']; ?>'>Descargar la Documentación Presentada</a></td>
                                                        <td><?php echo htmlspecialchars($activacion[$row['activation']]); ?> </td>
                                                        <td>
                                                            <form action="Action/accion_solicitud_Doc.php" method="post" >
