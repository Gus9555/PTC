                ...
                <ul class="navbar-right list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                            <a class="dropdown-item" href="../Admin/seguros.php"><img
                    ...
                    <li class="dropdown notification-list list-inline-item">
                        <div class="dropdown notification-list nav-pro-img">
                            <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown"
                                ...
                                <img src="../../assets/images/users/gear.png" alt="usuario" class="rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                <a class="dropdown-item" href="#"><i class="mdi mdi-account-circle"></i> Perfil</a>
                                
                                <a class="dropdown-item text-danger" href="../user/logout.php"><i class="mdi mdi-power text-danger"></i> Cerrar sesión</a>
                            </div>
                        </div>
                    </li>
                </ul>
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="Tabla_taller.php">Tabla de Taller Mecánico</a></li>
                        ...
                        <li>
                            ...
                            Tabla de Beneficiarios Registrados<span class="float-right menu-arrow"><i
                                            class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                                <li><a href="Tabla_datosVehi.php">Datos de Póliza de Vehículo</a></li>
                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tabla de seguros</h4>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Tabla de seguros</li>
                                    </ol>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Editar Seguro en LifeLine</h4>
                                    
                                    <p class="sub-title">En esta sección puedes editar los seguros disponibles.
                                    </p>
                                        ...
                                        <tbody>
                                            <?php foreach ($resultado as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal" data-id="<?php echo $row['id']; ?>" data-seguro="<?php echo $row['seguro']; ?>" data-calidad="<?php echo $row['calidad']; ?>" data-descripcion="<?php echo $row['descripcion']; ?>" data-descripcion2="<?php echo $row['descripcion2']; ?>" data-descripcion3="<?php echo $row['descripcion3']; ?>" data-descripcion4="<?php echo $row['descripcion4']; ?>" data-descripcion5="<?php echo $row['descripcion5']; ?>" data-descripcion6="<?php echo $row['descripcion6']; ?>" data-precio="<?php echo $row['precio']; ?>">Editar</button>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Editar Seguro</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="update_insurance.php" method="post">
                    <div class="modal-body">
                        <input type="hidden" name="id" id="insuranceId">
                        <div class="form-group">
                            <label for="insuranceName">Seguro</label>
                            <input type="text"onpaste="return false;" class="form-control" id="insuranceName" name="seguro">
                        </div>
                        <div class="form-group">
                            <label for="insuranceQuality">Calidad</label>
                            <input type="text"onpaste="return false;" class="form-control" id="insuranceQuality" name="calidad">
                        </div>
                        <div class="form-group">
                            <label for="description1">Descripción 1</label>
                            <input type="text"onpaste="return false;" class="form-control" id="description1" name="descripcion">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description3">Descripción 3</label>
                            <input type="text" onpaste="return false;"class="form-control" id="description3" name="descripcion3">
                        </div>
                        <div class="form-group">
                            <label for="description4">Descripción 4</label>
                            <input type="text" onpaste="return false;"class="form-control" id="description4" name="descripcion4">
                        </div>
                        <div class="form-group">
                            <label for="description5">Descripción 5</label>
                            <input type="text"onpaste="return false;" class="form-control" id="description5" name="descripcion5">
                        </div>
                        <div class="form-group">
                            <label for="description6">Descripción 6</label>
                            <input type="text" onpaste="return false;"class="form-control" id="description6" name="descripcion6">
                        </div>
                        <div class="form-group">
                            <label for="insurancePrice">Precio</label>
                            <input type="text"onpaste="return false;" class="form-control" id="insurancePrice" name="precio">
                        </div>
                    </div>
