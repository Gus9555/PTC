...
<body>
    ...
    try {
        $pdo = getConnection();
        // Obtener todas las compras para la tabla
        $sqlUsers = "SELECT * FROM compras";
    ...
    <body>
                    ...
                    <ul class="navbar-right list-inline float-right mb-0">
                        ...
                        <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                                <a class="dropdown-item" href="../Admin/tabla_compras.php"><img
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center ">
                                <div class="col-md-8">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Tabla de Compras</h4>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Tabla de Compras</h4>
                                        <p class="sub-title">Aquí puedes ver todos los pagos registrados en la plataforma.
                                        </p>
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                <?php foreach ($resultado as $row) { ?>
                                                    <tr>
                                                        <td><?php echo htmlspecialchars($row['id_c']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['nombre']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['correo']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['numero_telefonico']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['user_id']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['estado']); ?></td>
                                                        <td><?php if ($row['seguro'] == "motorcycle") {
                                                            $row['seguro'] = "Motocicleta";
                                                        } elseif ($row['seguro'] == "Vehicule") {
                                                            $row['seguro'] = "Vehículo";
                                                        }
                                                         echo htmlspecialchars($row['seguro']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['calidad']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['precio']); ?></td>
                                                        <td>
                                                        <button class="btn btn-danger" onclick="confirmDelete(<?php echo htmlspecialchars($row['id_c']); ?>)">Delete</button>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
        ...
        <script>
            ...
            var userChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ['Total de Usuarios', 'Admins', 'Usuarios', 'Soporte'],
                    datasets: [{
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            text: "Tu no podras revertir el cambio",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                form.method = "POST";
                form.action = "eliminar_compra_S.php";
