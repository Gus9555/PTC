...
<head>
    ...
    <title>Usuarios Pendientes de Pago</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            <a class="navbar-brand logo-image" ><img src="../../assets/boss/images/logo.png" alt="alternative"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="users.php">CHAT<span class="sr-only">(actual)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="finance.php">FINANZAS <span class="sr-only">(actual)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="../support/finance.php">ENGLISH <span class="sr-only">(actual)</span></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Usuarios Pendientes de Pago</h1>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-12">
                <button class="btn btn-primary mb-3" onclick="enviarCorreos()">Enviar Correo</button>
                <h1 class="mt-5">Detalles del Pago</h1>
